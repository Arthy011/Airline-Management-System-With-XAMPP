            ...
            <form class="needs-validation" action="confirm_ticket.php" method="post" onsubmit="return formValidation()">
                ...
                <div class="row">
                    <div class="col-md-5 mb-3">
                        ...
                        <input type="text" class="form-control" name="country" pattern="[a-zA-Z]+" maxlength="50" title="Max 50 alphabets without digits are required." placeholder="Eg:Bangladesh" required>
                    </div>
